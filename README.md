...
The data for the Nashville Rock-and-Roll Marathon that you worked with in Excel was originally scraped from the website's race results page. Now it's your turn to scrape the data! The number of pages of results for each race and the base URL that you will build out is provided below.
...
**After loading the marathon and half-marathon data into DataFrames in Python, perform EDA as usual. Think of a question that you find interesting and answer it with the data. Prepare a brief (5 minutes) presentation to share what you found.**
